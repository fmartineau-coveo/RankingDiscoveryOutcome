  ...
  return (
    <div className="rounded-2xl border border-dashed border-ink-300 bg-white p-12 text-center shadow-soft">
      ...
      <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-ink-600">
        Open any of the 28 concepts and use <span className="inline-flex items-center gap-1 align-middle font-medium text-ink-800"><Pin className="h-3 w-3" /> Pin view</span> in the top-right to add it to your shortlist. Pins remember the specific product, pair, or scenario you were looking at.
      </p>
      <div className="mt-5">
        <Link
          to="/gallery"
