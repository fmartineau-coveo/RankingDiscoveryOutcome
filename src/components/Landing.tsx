        ...
        <div className="mb-6 flex items-end justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-ink-600">
              {allShown
                ? 'Thirteen grounded / enterprise-ready patterns and fifteen bold / visionary ones. Every concept is grounded in one of the two approved explainability approaches and uses the same sofas PLP so they can be compared side-by-side.'
    ...
    <section className="relative overflow-hidden rounded-3xl border border-ink-200 bg-hero paper shadow-card">
      <div className="noise relative px-10 pb-14 pt-16">
        ...
        <p className="mt-6 max-w-2xl text-[15px] leading-relaxed text-ink-700">
          ...
          LLM-powered <strong>Pairwise Narrative</strong>. This showcase presents 28 ways those
