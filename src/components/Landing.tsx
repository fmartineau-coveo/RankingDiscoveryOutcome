      ...
      <section>
        <div className="mb-6 flex items-end justify-between">
          <div>
            ...
            <h2 className="display text-4xl text-ink-900">16 concept directions</h2>
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-ink-600">
              Eight grounded / enterprise-ready patterns and eight bold / visionary ones. Every
    ...
    <section className="relative overflow-hidden rounded-3xl border border-ink-200 bg-hero paper shadow-card">
      <div className="noise relative px-10 pb-14 pt-16">
        ...
        <p className="mt-6 max-w-2xl text-[15px] leading-relaxed text-ink-700">
          ...
          LLM-powered <strong>Pairwise Narrative</strong>. This showcase presents 16 ways those
